...
export const authErrorPresentation: Record<AuthErrorCode, ErrorPresentation> = {
  ...
  AUTH_ACCOUNT_NOT_ACTIVATED: {
    ...
    message: "Your account has not been activated yet. Check your email for the activation link.",
  },
  ...
  AUTH_ACTIVATION_TOKEN_INVALID: {
    ...
    message: "This activation link is invalid. Please contact your administrator for a new one.",
  },
  AUTH_ACTIVATION_TOKEN_EXPIRED: {
    variant: "error",
    title: "Activation link expired",
    message: "This activation link has expired. Please contact your administrator for a new one.",
  },
